...
export class HandshakeResponse {
  ...
  static fromPacket(packet: Packet) {
    ...
    const isSet = (flag: keyof typeof ALL_CLIENT_CONSTANTS) =>
      args.clientFlags & ALL_CLIENT_CONSTANTS[flag];

    args.maxPacketSize = packet.readInt32();
    args.charsetNumber = packet.readInt8();
    const encoding = 'utf8'; // CharsetToEncoding[args.charsetNumber];
    ...
    if (isSet('PLUGIN_AUTH_LENENC_CLIENT_DATA')) {
      authTokenLength = packet.readLengthCodedNumber(false, false);
